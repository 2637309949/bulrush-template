...
func RegisterUser(r *gin.RouterGroup, role *role.Role) {
	MGOExt.API.List(r, "User").Pre(func(c *gin.Context) {
		Logger.Info("after")
	}).Auth(func(c *gin.Context) bool {
		return true
	})
	MGOExt.API.Feature("feature").List(r, "User")
	MGOExt.API.One(r, "User", role.Can("r1,r2@p1,p3,p4;r4"))
	MGOExt.API.Create(r, "User")
	MGOExt.API.Update(r, "User")
	MGOExt.API.Delete(r, "User")
}
